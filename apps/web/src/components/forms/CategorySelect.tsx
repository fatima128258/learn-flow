  ...
  return (
    <div className="w-full">
      ...
      <Select
        ...
        buttonClassName="rounded-xl border border-[#e5d5c4] bg-[#fffdf9] px-4 py-3 text-base text-[#17212b] shadow-none focus:border-[#7a4a2e] focus:ring-2 focus:ring-[#a8784f]/20"
