...
async function deleteAuditTestOrg() {
  try {
    console.log('🔍 Finding all "Audit Test Org" organizations...\n');
    ...
    if (organizations.length === 0) {
      console.log('❌ No organizations found with name "Audit Test Org"');
      return;
    }
    
    console.log(`✅ Found ${organizations.length} organization(s) with name "Audit Test Org"\n`);
    ...
    console.log(`\n${'='.repeat(60)}`);
    console.log(`⚠️  WARNING: This will delete ALL ${organizations.length} "Audit Test Org" organization(s) and their related data!`);
    ...
    console.log(`\n✅ All ${organizations.length} "Audit Test Org" organization(s) deleted successfully!`);
