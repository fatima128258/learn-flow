...
type TaskForm = { title: string; description: string; status: TaskStatus; priority: Priority };
const emptyForm: TaskForm = { title: '', description: '', status: 'PENDING', priority: 'MEDIUM' };
