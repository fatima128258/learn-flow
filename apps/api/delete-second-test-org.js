...
async function deleteSecondTestOrganization() {
  try {
    console.log('🔍 Finding all "Second Test Organization" organizations...\n');
    ...
    if (organizations.length === 0) {
      console.log('❌ No organizations found with name "Second Test Organization"');
      return;
    }
    
    console.log(`✅ Found ${organizations.length} organization(s) with name "Second Test Organization"\n`);
    ...
    console.log(`\n${'='.repeat(60)}`);
    console.log(`⚠️  WARNING: This will delete ALL ${organizations.length} "Second Test Organization" organization(s) and their related data!`);
    ...
    console.log(`\n✅ All ${organizations.length} "Second Test Organization" organization(s) deleted successfully!`);
