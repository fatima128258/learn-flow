...
const ChatIcon: React.FC = () => (
  <svg className="h-5 w-5 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M8 10h8M8 14h5m7-2a8 8 0 01-8 8 8.5 8.5 0 01-4.2-1.1L4 20l1.1-3.8A8 8 0 1120 12z" />
  </svg>
);
...
function NavLink({
  ...
  return (
    <Link
      ...
      className={`dashboard-nav-link group relative flex w-full items-center rounded-xl border-0 px-3 py-2.5 text-sm transition-colors duration-200 focus:border-0 focus:outline-none focus-visible:border-0 focus-visible:outline-none focus-visible:ring-0 ${
  ...
  return (
    <div className="min-h-screen bg-background-alt">
      ...
      >
        {/* Header */}
        <div
          className={`flex h-16 items-center border-b border-[#ead8c6] ${
      ...
      <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-[#ead8c6] bg-white/90 px-4 backdrop-blur lg:hidden">
        <button
          ...
          className="rounded-md p-2 text-neutral-700 hover:bg-neutral-100 focus:outline-none focus:ring-0"
