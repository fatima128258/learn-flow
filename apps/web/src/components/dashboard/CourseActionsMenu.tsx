  ...
  const menu = open ? (
    ...
    >
      {onViewClick && (
        <>
          <button
            ...
            className="flex w-full border-0 items-center gap-2.5 px-4 py-2.5 text-sm text-neutral-700 hover:bg-neutral-50 focus:border-0 focus:outline-none focus-visible:border-0 focus-visible:outline-none focus:ring-0 focus-visible:ring-0"
          >
      ...
      <a
        ...
        className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-neutral-700 hover:bg-neutral-50 focus:outline-none focus-visible:outline-none"
      >
        <svg className="h-4 w-4 shrink-0 text-neutral-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  return (
    <>
      <button
        ...
        type="button"
        onClick={openMenu}
        className="inline-flex items-center justify-center rounded-lg border-0 p-1.5 text-neutral-400 hover:bg-neutral-100 hover:text-neutral-700 focus:border-0 focus:outline-none focus-visible:border-0 focus-visible:outline-none focus:ring-0 focus-visible:ring-0"
