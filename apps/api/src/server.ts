...
import ownerPaymentDetailRouter from './routes/ownerPaymentDetailRoutes';
import certificateRouter, { publicCertificateRouter } from './routes/certificateRoutes';
import searchRouter from './routes/searchRoutes';
import publicCourseRouter from './routes/publicCourseRoutes';
...
app.use('/api/v1/organizations', ownerPaymentDetailRouter);
