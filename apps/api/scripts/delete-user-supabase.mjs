...
async function deleteUserByEmail(email) {
  try {
    console.log(`🗑️  Starting deletion of user from Supabase: ${email}...`);
    ...
    console.log('\n🧹 Deleting associated data from Supabase...');
    ...
    console.log(`\n✅ Successfully deleted user from Supabase: ${email}`);
...
if (!email) {
  console.log('Usage: node delete-user-supabase.mjs <email>');
  console.log('Example: node delete-user-supabase.mjs ali@gmail.com');
  process.exit(1);
}
