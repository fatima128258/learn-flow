        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={`dashboard-nav-link flex items-center gap-3 rounded-lg border-0 px-3 py-2 text-sm transition-colors focus:border-0 focus:outline-none focus-visible:border-0 focus-visible:outline-none focus-visible:ring-0 ${
                isActive
