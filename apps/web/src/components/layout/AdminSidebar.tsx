        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={`dashboard-nav-link flex items-center gap-3 rounded-lg px-3 py-2 text-sm transition-colors focus:outline-none focus-visible:outline-none focus-visible:ring-0 ${
                isActive
